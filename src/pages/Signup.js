...
const Signup = () => {
        ...
        return(
            <SectionContainer size={100} bg_color={colors.primary}>
                <TopBar className="top_bar">
                    {/* <BackLink to={"alricantoken.com"}> <BsArrowLeft size={25} /> </BackLink> */}
                    {/* <a href="https://alricantoken.com"> <BsArrowLeft size={25} /> </a> */}
                    <BackTitle>ALRICAN TOKEN</BackTitle>
                </TopBar>
    ...
    if(!isloading) {
        return(
            <NoUserContainer>
                <NoUserText>Oops... The link does not exist!</NoUserText>
                <NoUserReturnBtn href="https://alricantoken.com">Go to homepage</NoUserReturnBtn>
            </NoUserContainer>
        )
    }
}
...
export const NoUserText = styled.h3`
    color: ${colors.accent};
`;
export const NoUserReturnBtn = styled.a`
    border: none;
